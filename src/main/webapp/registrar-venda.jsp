...
<%@ page import="model.JavaBeansVendasProdutos"%>
<%
...
<link href="styles/venda.css" type="text/css" rel="stylesheet">
<style>
#registrar {
	width: 300px;
}
...
<body>
		...
		<nav class="navbar bg-light navbar-light navbar-expand-md fixed-top">
			...
			<div class="collapse navbar-collapse" id="conteudoNavbarSuportado">
				<ul class="navbar-nav mr-auto">
					...
					<li class="nav-item" style="margin-left: 10px;"><a
						class="nav-link" href="registrar-venda">Registrar Venda</a></li>
				</ul>
			</div>
			<div>
				<ul class="navbar-nav mr-auto">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="col-md-12">
						...
						<table class="table-sm">
							<thead>
								<tr>
									...
									<th scope="col" width="10%">Opções</th>
								</tr>
							</thead>
							<tbody>
								<%
								...
								%>
								<tr>
									<td class="nome"><%=lista.get(i).getNome_produto()%></td>
									<td class="valor"><%="R$ " + lista.get(i).getValor_produto()%></td>
									<td class="options" style="text-align: center;">
										<button class="add">
											<img src="./img/add.png" alt="Adicionar Produto" title="Add">
										</button>
									</td>
									<%
									}
						...
						<h3 id="subtitle" style="font-style: italic;">Nenhum produto
							selecionado</h3>
						<table id="myTable" class="table-sm">
							<thead id="tHead">
								<tr id="trHead">
									<th scope="col" width="60%">Nome</th>
									<th scope="col" width="30%">Valor</th>
						...
						<h3 id="qtdtotal" style="text-align: left"></h3>
					</div>
					<form name="frmVenda" action="inserir-venda">
						<div class="col-md-12">
							<input type="text" name="nome" maxlength="100" required
								placeholder="Nome Cliente" class="input"> <input
								type="number" name="cep" min="000000000" maxlength="8" required
								placeholder="CEP (somente números)" class="input">
						</div>
						<div class="col-md-12">
							<input type="number" name="n_casa" required placeholder="Nº Casa"
								class="input"> <input type="number" name="cpf_cliente"
								required placeholder="CPF (somente números)" class="input">
						</div>
						<div class="col-md-12">
							<input type="radio" id="credito" name="pagamento"
								value="Cartão de Crédito" style="padding: 0;"> <label
								for="credito">Crédito</label> <input type="radio" id="debito"
								name="pagamento" value="Cartão de Débito"> <label
								for="debito">Débito</label> <input type="radio" id="dinheiro"
								name="pagamento" value="Dinheiro"> <label for="dinheiro">Dinheiro</label>
							<input type="text" name="obs" required placeholder="Observações"
								class="input"> <input type="hidden" name="produtos">
								<input type="hidden" name="valor_final">
						</div>

						<div class="col-md-12 mt-5">
							<button type="submit" class="btn" id="registrar" onclick="validar()">Registrar</button>
						</div>
	...
	<script src="scripts/validador_venda.js"></script>
