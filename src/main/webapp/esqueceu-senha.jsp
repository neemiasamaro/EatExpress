...
<link href="styles/esqueceu-senha.css" type="text/css" rel="stylesheet">
</head>
<body>
	<header>
		<nav class="navbar bg-light navbar-light navbar-expand-md fixed-top">
			...
			<div class="collapse navbar-collapse" id="conteudoNavbarSuportado">
				<ul class="navbar-nav mr-auto">
					...
					<li class="nav-item" style="margin-left: 10px;"><a
						class="nav-link" href="registrar-venda">Registrar
							Venda</a></li>
				</ul>
			</div>
			<div>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="card container-fluid">
					<form name="frmRedefinir" action="redefinir" method="get"
						...
						<div class="mb-3">
							...
							<a href="#" type="button" onclick="validarFormRedefinir()"
								class="btn">Enviar Email</a>
							<script>
