...
<body>
			...
			<div class="row">
				<div class="col-md-12" style="text-align: center; margin-top: 15px;">
					<a href="Home"><img alt="Logo" src="img/frame.png"
						class="logo grow img-fluid"></a>
					<form class="mt-5" name="frmCadastro" action="insert">
						<div class="col-md-12">
						...
						<div class="col-md-12">
							<input type="password" name="senha" maxlength="8" required
								id="pass" placeholder="Senha"> <img src="img/olho.png"
								id="olho" class="olho"> <input type="password"
								name="senha2" maxlength="8" required
								placeholder="Confirmar Senha"><img src="img/olho.png"
								id="olho" class="olho">
						</div>
						<div class="col-md-12" style="margin-top: 30px;">
							<a href="Home" class="btn voltar">Voltar</a>
							<button type="submit" onclick="validarCadastroFunc()" class="btn">Cadastrar-se</button>
						</div>
					</form>
				</div>
			</div>
	...
	<script src="scripts/validador_cadastro_user.js"></script>
